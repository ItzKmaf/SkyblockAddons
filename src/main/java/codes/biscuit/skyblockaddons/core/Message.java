...
public enum Message {
    ...
    SETTING_PICKAXE_ABILITY_COOLDOWN(MessageObject.SETTING, "Show Pickaxe Ability Cooldown"),
    ...
    MESSAGE_MINING_ABILITY_AVAILABLE(MessageObject.MESSAGES, "miningAbilityAvailable"),
