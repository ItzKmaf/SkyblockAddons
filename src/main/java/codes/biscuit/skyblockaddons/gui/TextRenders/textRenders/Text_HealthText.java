...
public class Text_HealthText implements TextRender {
	
	@Override
	public String getText() {
		return SkyblockAddons.getInstance().getUtils().getAttributes().get(Attribute.HEALTH) + "/" +
				SkyblockAddons.getInstance().getUtils().getAttributes().get(Attribute.MAX_HEALTH);
	}
